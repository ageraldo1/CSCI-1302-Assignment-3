...
public class Validator {
    ...
    public static int rangeBetweenZeroes ( ArrayList<Integer> arrayNumbers) {
    ...
    public static void validateRangeBetweenZeroes() {
    ...
    public static void removeInRange(ArrayList<String> sentence, String begin, String end) {
